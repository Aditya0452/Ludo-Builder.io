      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-purple-200 max-w-2xl mx-auto">
            Compete in exciting tournaments with progressive elimination rounds
          ...
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 p-4 rounded-lg border border-yellow-500/30">
                ...
                <p className="text-yellow-200 text-sm">
                  Join tournaments with 64, 32, 16, 8, or 4 players. Teams are
                  automatically created with 4 players each.
                </p>
              </div>
              <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 p-4 rounded-lg border border-yellow-500/30">
                <h4 className="text-white font-semibold mb-2">
                ...
                <p className="text-yellow-200 text-sm">
                  Winners from each team advance to the next level. Background
                  changes with each level progression.
                </p>
              </div>
              <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 p-4 rounded-lg border border-yellow-500/30">
                <h4 className="text-white font-semibold mb-2">🎁 Rewards</h4>
                <p className="text-yellow-200 text-sm">
                  Top 4 finalists receive gold coin rewards. 1st place gets the
                  biggest prize!
                </p>
              </div>
            </div>
            <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 p-4 rounded-lg border border-purple-500/30">
              ...
              <p className="text-purple-200 text-sm">
                Option to team up as 2+2 players. If your teammate reaches the
                final path first, they can help you. Otherwise, continue as
                1vs3.
              </p>
            </div>
          </CardContent>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
          {tournaments.map((tournament) => (
            <Card
              key={tournament.id}
              className="bg-black/20 border-white/10 backdrop-blur-sm hover:scale-105 transition-transform"
            >
              <CardHeader>
